...
Of course, some bugs have been fixed along the way as well. List loading displays correct error message when offline, previously this had been incorrectly reported as service unavailable. In some use cases, during search, the mini-player obscured lists. This has been fixed.
